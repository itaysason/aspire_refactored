...
from aspire.abinitio.C1.cryo_clmatrix import cryo_clmatrix_cpu
from aspire.abinitio.C1.cryo_estimate_mean import cryo_estimate_mean
from aspire.abinitio.C1.cryo_syncmatrix_vote import cryo_syncmatrix_vote
from aspire.abinitio.C1.cryo_sync_rotations import cryo_sync_rotations
from aspire.abinitio.C1.cryo_estimate_shifts import cryo_estimate_shifts
import time
...
def cryo_abinitio_c1_worker(stack, algo, n_theta=360, n_r=0.5, max_shift=0.15, shift_step=1):
    ...
    default_logger.debug(f"Reconstructing from {num_projections} images")
